...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-u5obzh8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-u5obzh8.containers.anotherwebservice.com/
...
```
git clone git@github.com:FavoShane/container-u5obzh8.git
cd container-u5obzh8
```
...
```
docker attach container-u5obzh8
```
